export const 명언 = `
나는 포기했을 때의 기분을 이미 알고 있다. 그래서 포기하지 않았을 때에 무슨 일이 일어날지 알고 싶다.//네일라 레이
피할수 없으면 즐겨라.//로버트 엘리엇
...
당신의 다리가 포기하는 것이 아니다. 당신의 머리가 포기하는 것이다. 계속 하라.//작자미상
운동은 몸의 건강을 위해 가장 중요한 것일 뿐 아니라, 다이나믹하고 창조적인 지적 활동을 위한 기반이기도 하다.//존 F. 케네디
운동 해야 한다. 그렇지 않으면 어느 순간 당신은 고장 날 것이다.//버락 오바마
당신이 하고 싶은 것을 할 수 있을 때까지, 당신이 해야 할 일을 해라.//오프라 윈프리
피할수 없으면 즐겨라.//로버트 엘리엇
...
이룰 수 없는 꿈을 꾸고 이길 수 없는 적과 싸우며, 이룰 수 없는 사랑을 하고 견딜 수 없는 고통을 견디고, 잡을수 없는 저 하늘의 별도 잡자.//세르반테스
...
독서는 마음을 위한 것이고, 운동은 몸을 위한 것이다.//조셉 애디슨
우리가 반복적으로 하는 것이 우리 자신을 만든다. 그러므로 우수하다는 것은 행동이 아닌 습관이다.//아리스토텔레스
내가 운동하는 이유는 삶의 질을 높여 인생을 즐기기 위함이다.//케너스 H. 쿠퍼
아침에 일어나 운동하는 것이, 매일 거울을 보고 자신의 모습을 싫어하는 것보다 쉬운 법이다.//작자미상
운동은 자극을 위한 것이지 몸을 괴롭혀 망하게 하는 것이 아니다. 세상이 하루 아침에 이루어 지지 않았듯, 우리 몸도 그렇다. 작은 목표부터 세우고, 이를 바탕으로 몸을 만들어라.//리 해니
세상에 있는 유일한 나쁜 운동은 안하는 운동 뿐이다.//작자미상
지금은 이 운동이 힘들지만, 언젠가는 워밍업이 될 것이다.//작자미상
인생은 당신이 편안한 환경에서 빠져 나올 때부터 시작된다.//작자미상
그만 두고 싶다는 생각이 들면, 왜 시작 했는지 생각하여 보라.//작자미상
사람이 자신의 몸이 가질 수 있는 아름다움과 강함을 알지 못하고 늙어 버리는 것은 안타까운 일이다.//소크라테스
운동은 당신의 몸이 가진 능력에 대한 축하이다. 당신이 먹은 것에 대한 벌이 아니라.//작자미상
운동하라. 잘 먹어라. 인내 하라. 당신의 몸은 보답할 것이다.//작자미상
운동은 사람의 몸과 감정과 정신력의 창조적 변화를 위한 약이다.//캐롤 웰치
오늘 당신이 느끼는 고통은 내일 당신이 느낄 힘이 될 것이다.//작자미상
변명을 늘어 놓는 것은 한 시간에 0 칼로리 밖에 소모하지 않는다.//작자미상
당신의 몸은 해 낼 수 있다. 당신의 마음만 설득하면 된다.//작자미상
우리가 늙어서 운동을 그만두는 것이 아니라, 우리가 운동을 그만두기 때문에 늙는 것이다.//케너스 쿠퍼
한번 운동의 결과를 맛 보고 나면, 중독 될 것이다.//작자미상
처음부터 다시 시작하는 일에 실증이 났다면, 하고 있는 일을 포기 하지 않으면 된다.//작자미상
나는 운동을 한 후 후회한 적은 없다. 하지만 운동을 하지 않은 후 언제나 후회했다.//작자미상
이른 아침 산책하는 것은 그날 하루 전체를 축복하는 일이다.//아담 스미스
운동을 위해 시간을 내지 않으면, 병 때문에 시간을 내야하게 될지도 모른다.//로빈 샤머
좋은 몸매는 단거리 빨리 달리기로 얻는 것이 아니다. 그것은 긴 여정이다.//게리 월쉬 제닝스
